...
function Profile() {
  ...
  return (
    <>
      ...
      <Collapse in={open}>
        <div className='row justify-content-center mt-2 shadow' id="example-collapse-text">
          <label className='text-center mt-3'>
            ...
            {
              existingImg == "" ?
                <img style={{ width: '200px' }} className='rounded-circle' src={preview ? preview : profileImg} alt="" />
                :
                <img style={{ width: '200px' }} className='rounded-circle' src={preview ? preview : `${SERVER_URL}/uploads/${existingImg}`} alt="" />
            }
          </label>
          <div className='mb-2'>
